...
public class LancamentoService {
	...
	//após a aplicação ser ativada, o método anotado com fixedDelay é chamado e 
	//depois após o tempo determinado = 30 min
	...
	*/
	...
	public void avisarSobreLancamentosVencidos() {
		...
		if (vencidos.isEmpty()) {
			logger.info("Sem lançamentos vencidos para este aviso");
			return;
		}
